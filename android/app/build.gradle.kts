...
android {
    namespace = "com.akburak.deadline"
    ...
    defaultConfig {
        applicationId = "com.akburak.deadline"
    ...
    signingConfigs {
        getByName("debug") {
            ...
            storeFile = keystoreProperties.getProperty("storeFile")?.let { rootProject.file(it) } ?: rootProject.file("~/.android/debug.keystore")
